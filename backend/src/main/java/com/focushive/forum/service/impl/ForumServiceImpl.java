...
public class ForumServiceImpl implements ForumService {
    ...
    @Override
    public ForumCategoryDTO updateCategory(Long categoryId, ForumCategoryDTO dto) {
    ...
    @Override
    public ForumCategoryDTO getCategory(Long categoryId) {
        ForumCategory category = categoryRepository.findById(categoryId)
            .orElseThrow(() -> new EntityNotFoundException("Category not found"));
        return mapToCategoryDTO(category);
    }
    ...
    @Override
    public List<ForumCategoryDTO> getHiveCategories(Long hiveId) {
    ...
    @Override
    public List<ForumCategoryDTO> getChildCategories(Long parentId) {
    ...
    public ForumPostDTO createPost(Long userId, ForumPostDTO dto) {
        ...
        subscribeToPost(post.getId(), userId, ForumSubscriptionDTO.builder()
    ...
    @Override
    public ForumPostDTO getPostBySlug(Long categoryId, String slug) {
    ...
    @Override
    public Page<ForumPostDTO> getPostsByHive(Long hiveId, Pageable pageable) {
    ...
    @Override
    public ForumReplyDTO getReply(Long replyId) {
        ForumReply reply = replyRepository.findById(replyId)
            .orElseThrow(() -> new EntityNotFoundException("Reply not found"));
    ...
    @Override
    public List<ForumReplyDTO> getPostReplies(Long postId) {
        List<ForumReply> replies = replyRepository.findByPostId(postId);
        return buildReplyTree(replies, null);
    }
    
    @Override
    public List<ForumReplyDTO> getTopLevelReplies(Long postId) {
    ...
    @Override
    public List<ForumReplyDTO> getChildReplies(Long parentReplyId) {
    ...
    @Override
    public ForumSubscriptionDTO updateSubscription(Long subscriptionId, ForumSubscriptionDTO dto) {
    ...
    @Override
    public void muteSubscription(Long subscriptionId, Integer hours) {
        ForumSubscription subscription = subscriptionRepository.findById(subscriptionId)
            .orElseThrow(() -> new EntityNotFoundException("Subscription not found"));
    ...
    @Override
    public void unmuteSubscription(Long subscriptionId) {
        ForumSubscription subscription = subscriptionRepository.findById(subscriptionId)
            .orElseThrow(() -> new EntityNotFoundException("Subscription not found"));
    ...
    @Override
    public void notifyNewReply(Long replyId) {
        // TODO: Implement WebSocket notification
        log.info("Notifying subscribers of new reply: {}", replyId);
    }
    
    @Override
    public void notifyReplyAccepted(Long replyId) {
        // TODO: Implement WebSocket notification
    ...
    private ForumCategoryDTO mapToCategoryDTO(ForumCategory category) {
        ForumCategoryDTO dto = ForumCategoryDTO.builder()
            ...
            .hiveId(category.getHive() != null ? category.getHive().getId() : null)
    ...
    private ForumPostDTO mapToPostDTO(ForumPost post, Long currentUserId) {
        ...
        if (currentUserId != null) {
            dto.setUserVote(getUserVoteOnPost(post.getId(), currentUserId));
    ...
    private ForumReplyDTO mapToReplyDTO(ForumReply reply, Long currentUserId) {
        ...
        if (currentUserId != null) {
            dto.setUserVote(getUserVoteOnReply(reply.getId(), currentUserId));
    ...
    private ForumVoteDTO mapToVoteDTO(ForumVote vote) {
        return ForumVoteDTO.builder()
            ...
            .replyId(vote.getReply() != null ? vote.getReply().getId() : null)
    ...
    private ForumSubscriptionDTO mapToSubscriptionDTO(ForumSubscription subscription) {
        ...
        if (subscription.getPost() != null) {
            dto.setPostId(subscription.getPost().getId());
    ...
    private List<ForumReplyDTO> buildReplyTree(List<ForumReply> replies, Long currentUserId) {
        ...
        for (ForumReply reply : replies) {
            ForumReplyDTO dto = replyMap.get(reply.getId());
            if (reply.getParentReply() == null) {
                rootReplies.add(dto);
            } else {
                ForumReplyDTO parent = replyMap.get(reply.getParentReply().getId());
                if (parent != null) {
