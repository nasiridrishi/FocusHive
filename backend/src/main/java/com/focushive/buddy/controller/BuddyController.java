...
public class BuddyController {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<BuddyRelationshipDTO> getRelationship(@PathVariable Long relationshipId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<List<BuddyGoalDTO>> getRelationshipGoals(@PathVariable Long relationshipId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<BuddyCheckinStatsDTO> getCheckinStats(@PathVariable Long relationshipId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<BuddyRelationshipStatsDTO> getRelationshipStats(@PathVariable Long relationshipId) {
