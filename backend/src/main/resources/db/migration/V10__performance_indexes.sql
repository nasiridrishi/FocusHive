...
CREATE INDEX IF NOT EXISTS idx_hive_members_active ON hive_members(active);
-- Composite index for common query pattern
CREATE INDEX IF NOT EXISTS idx_hive_members_hive_user ON hive_members(hive_id, user_id);
CREATE INDEX IF NOT EXISTS idx_hive_members_user_active ON hive_members(user_id, active);
...
CREATE INDEX IF NOT EXISTS idx_focus_sessions_user_date_range ON focus_sessions(user_id, started_at, completed_at);
...
CREATE INDEX IF NOT EXISTS idx_buddy_relationships_requested ON buddy_relationships(requested_id);
CREATE INDEX IF NOT EXISTS idx_buddy_relationships_status ON buddy_relationships(status);
CREATE INDEX IF NOT EXISTS idx_buddy_sessions_buddy_rel ON buddy_sessions(buddy_relationship_id);
CREATE INDEX IF NOT EXISTS idx_buddy_sessions_scheduled_at ON buddy_sessions(scheduled_at);
...
CREATE INDEX IF NOT EXISTS idx_hives_active_true ON hives(id, name, created_at) WHERE active = true;
CREATE INDEX IF NOT EXISTS idx_users_active_true ON users(id, username, email) WHERE active = true;
CREATE INDEX IF NOT EXISTS idx_focus_sessions_active ON focus_sessions(user_id, hive_id, started_at) WHERE completed = false;
