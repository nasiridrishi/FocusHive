...
@ContextConfiguration(classes = {NotificationControllerTestConfig.class, com.focushive.test.UnifiedTestConfig.class})
class NotificationControllerTest {
    ...
    void createNotification_UserNotFound_BadRequest() throws Exception {
        ...
        mockMvc.perform(post("/api/notifications")
                ...
                .content(objectMapper.writeValueAsString(createRequest)))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.message").value("User not found: " + testUserId));
    }
