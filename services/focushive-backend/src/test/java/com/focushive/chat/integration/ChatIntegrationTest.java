...
public class ChatIntegrationTest {
    ...
    void setUp() {
        ...
        testUser.setPassword("hashedpassword123"); // Meet min 8 characters requirement
        ...
        otherUser.setPassword("hashedpassword456"); // Meet min 8 characters requirement
        otherUser.setDisplayName("Other User");
        otherUser.setRole(User.UserRole.USER);
        otherUser.setEnabled(true);
        otherUser.setEmailVerified(true);
        otherUser.setAccountNonExpired(true);
        otherUser.setAccountNonLocked(true);
        otherUser.setCredentialsNonExpired(true);
    ...
    void messagesAfterTimestamp_FiltersCorrectly() {
        ...
        ChatMessage oldMessage = ChatMessage.builder()
                ...
                .messageType(ChatMessage.MessageType.TEXT)
                .build();
        oldMessage = chatMessageRepository.save(oldMessage);
        ...
        // Wait again before creating new message
        try {
            Thread.sleep(10);
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
