...
class PresenceControllerTest {
    ...
    @BeforeEach
    void setUp() {
        // Principal stubbing will be done in individual tests that need it
    }
    ...
    void subscribeToHivePresence_shouldReturnCurrentPresenceInfo() {
        ...
        verify(presenceService, times(2)).getHiveActiveUsers(hiveId);
        // Note: getHiveFocusSessions is not called by the actual controller implementation
