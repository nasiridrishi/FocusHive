...
-- Migration: V20241212_2__Add_Security_Audit_Log.sql
...
CREATE TABLE security_audit_log (
    ...
    INDEX idx_security_audit_operation (operation),
    INDEX idx_security_audit_resource_type (resource_type),
    INDEX idx_security_audit_created_at (created_at),
    INDEX idx_security_audit_access_granted (access_granted)
);
