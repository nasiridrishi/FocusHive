...
@Repository
public interface BuddyGoalRepository extends JpaRepository<BuddyGoal, String> {
    
    List<BuddyGoal> findByRelationshipIdOrderByCreatedAtDesc(String relationshipId);
