...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    data TEXT DEFAULT '{}',  -- Changed from JSONB to TEXT for H2 compatibility
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,  -- Changed from NOW() for H2 compatibility
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,  -- Changed from NOW() for H2 compatibility
