...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "OAuth2 token revocation request")
public class OAuth2RevocationRequest {

    @NotBlank(message = "Token is required")
    @Schema(description = "Token to revoke", example = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...")
