...
const MessageBubble: React.FC<MessageBubbleProps> = ({
  ...
  const groupReactions = (reactions: MessageReaction[]): Array<{emoji: string; count: number; users: string[]; hasCurrentUser: boolean}> => {
  ...
  const renderReplyTo = (): React.ReactElement | null => {
  ...
  const renderReactions = (): React.ReactElement | null => {
