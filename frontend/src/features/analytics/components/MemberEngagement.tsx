...
import {Group, Person, PlayCircle, Timer} from '@mui/icons-material';
import {BarChart} from '@mui/x-charts/BarChart';
import {MemberEngagementData, MemberEngagementProps} from '../types';
import {format} from 'date-fns';

const getEngagementColor = (engagement: MemberEngagementData['engagement']): 'success' | 'warning' | 'error' | 'primary' => {
  switch (engagement) {
    case 'high':
      return 'success';
    case 'medium':
