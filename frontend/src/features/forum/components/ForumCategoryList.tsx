...
const ForumCategoryList: React.FC<ForumCategoryListProps> = ({
  ...
  const handleCategoryClick = (category: ForumCategory): void => {
  ...
  const getCategoryIcon = (icon?: string, color?: string): React.ReactElement => {
  ...
  const getAccessIcon = (category: ForumCategory): React.ReactElement | null => {
