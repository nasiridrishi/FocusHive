...
import {AchievementBadge, LeaderboardCard, PointsDisplay, StreakCounter,} from '../components';
import {GamificationProvider, useGamification} from '../contexts';
import type {Achievement, Leaderboard, Streak} from '../types';
  ...
  return (
      <Container maxWidth="desktop" sx={{py: 4}}>
        ...
        <Typography variant="body1" align="center" color="text.secondary" paragraph>
          A comprehensive gamification system featuring points, achievements, streaks, and
          leaderboards
        </Typography>
          ...
          <CardContent>
            ...
            {stats && (
                <Box sx={{mt: 2}}>
                  ...
                  <Typography variant="body1" paragraph>
                    <strong>Achievements
                      Unlocked:</strong> {stats.achievements.filter(a => a.isUnlocked).length} of {stats.achievements.length}
                  </Typography>
                  <Typography variant="body1" paragraph>
                    <strong>Active
                      Streaks:</strong> {stats.streaks.filter(s => s.isActive).length} of {stats.streaks.length}
                  </Typography>
                </Box>
            )}
        ...
        <Card>
          <CardContent>
            ...
            <ul>
              ...
              <li><strong>Achievement System:</strong> Unlock badges with different rarities and
                progress tracking
              </li>
              <li><strong>Streak System:</strong> Maintain consistency with visual streak counters
              </li>
              <li><strong>Leaderboard System:</strong> Compete with others and track rank changes
              </li>
