...
import {EmojiEvents, Remove, Schedule, TrendingDown, TrendingUp,} from '@mui/icons-material';
import type {Leaderboard, LeaderboardCardProps} from '../types/gamification';
import {formatPoints, formatRankChange, getUserInitials,} from '../utils/gamificationUtils';
...
const LeaderboardCard: React.FC<LeaderboardCardProps> = ({
  ...
  const getPodiumClass = (rank: number): string => {
    switch (rank) {
      case 1:
        return 'podium-gold';
      case 2:
  ...
  const getRankChangeIcon = (change?: number): React.ReactElement => {
