...
import {PresenceStatus, User} from '@shared/types'
...
const getPresenceColor = (status: PresenceStatus = 'offline'): string => {
  switch (status) {
    case 'online':
      return '#4caf50'
    case 'focusing':
...
const getPresenceText = (status: PresenceStatus = 'offline'): string => {
  switch (status) {
    case 'online':
      return 'Online'
    case 'focusing':
...
export default function UserProfileMenu({
  ...
  const getAvatarSrc = (user: User): string | undefined => {
