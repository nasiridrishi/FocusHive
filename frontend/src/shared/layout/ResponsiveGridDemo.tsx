  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <ResponsiveGrid columns={4} gap={2} sx={{ mb: 4 }}>
        <GridItem span={2}>
          <Paper sx={{ p: 2, height: 80, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Typography variant="body2" sx={{ mt: 3, color: 'success.main' }}>
        ✅ If you can see this demo without browser crashes, the infinite recursion bug has been successfully fixed!
      </Typography>
    </Box>
  );
};