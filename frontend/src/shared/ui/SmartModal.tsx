...
import {useDynamicViewportHeight, useReducedMotion, useResponsive, useTouchGestures} from '../hooks'
...
export const SmartModal: React.FC<SmartModalProps> = ({
  ...
  const getTransitionComponent = (): React.ComponentType<unknown> | undefined => {
