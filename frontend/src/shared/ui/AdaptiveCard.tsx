...
import {useContainerQuery, useLazyImage, useResponsive} from '../hooks'
...
// Props interfaces
interface AdaptiveCardProps extends Omit<CardProps, 'title' | 'variant'> {
  // Content props
...
export const AdaptiveCard = forwardRef<HTMLDivElement, AdaptiveCardProps>(
    ({
      ...
      const renderCardActions = (): React.ReactNode => {
