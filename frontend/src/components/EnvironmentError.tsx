...
const copyToClipboard = async (text: string): Promise<void> => {
  try {
    ...
    logger.error('Failed to copy text to clipboard', 'EnvironmentError', err);
  }
};
            ...
            <CardContent>
              ...
              <Stack spacing={3}>
                <Alert severity="info">
                  ...
                  Copy the example configuration below to a <code>.env</code> file in your project
                  root and update the values as needed.
                </Alert>
