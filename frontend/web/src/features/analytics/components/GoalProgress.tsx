...
const getPriorityColor = (priority: GoalProgressData['priority']) => {
  switch (priority) {
...
const getCategoryColor = (category: GoalProgressData['category']) => {
  switch (category) {
    case 'focus': return '#1976d2';
    case 'productivity': return '#388e3c';
    case 'collaboration': return '#f57c00';
    case 'wellness': return '#7b1fa2';
