    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          // Dynamic padding based on layout state
          paddingTop: `${contentPadding.top}px`,
          paddingBottom: `${contentPadding.bottom}px`,
          paddingLeft: isDesktop && sidebarOpen ? `${contentPadding.left}px` : 0,
          ...
          paddingLeft: 'max(env(safe-area-inset-left), ' + (isDesktop && sidebarOpen ? `${contentPadding.left}px` : '0px') + ')',
